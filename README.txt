# LaTeX UTFPR
Modelo para Trabalho de Conclusão de Curso da UTFPR conforme manual Normas para Elaboração de Trabalhos Acadêmicos da UTFPR
...
# Editar-------------------------------------------------------------------------------------------------------------------------
No arquivo principal "utfpr-tcc.tex" estão todas as inclusões das partes do trabalho, caso não queira inserir algum dos elementos basta excluir a linha com o comando \include deste arquivo.

Caso queira incluir mais capítulos dentro da pasta "desenvolvimento" basta criar o arquivo .tex dentro da pasta e incluí-lo via comando \include no arquivo principal "utfpr-tcc.tex".
